...
if (!empty($_SESSION['active'])) {
  ...
  Ingrese su usuario y su clave
      ...
      FROM usuario u INNER JOIN rol r ON u.rol = r.idrol WHERE u.usuario = '$user' AND u.clave = '$clave'");
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image">
                <img src="sistema/img/logos.jpg" class="img-thumbnail">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
